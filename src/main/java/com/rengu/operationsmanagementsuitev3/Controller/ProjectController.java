...
public class ProjectController {
    ...
    @Autowired
    public ProjectController(ProjectService projectService, DeviceService deviceService, ComponentService componentService, DeploymentDesignService deploymentDesignService, DeployLogService deployLogService, UserService userService, CustomParametersService customParametersSercice) {
    ...
    //保存自定义参数
    @PostMapping(value = "/saveCustomParameters")
    public ResultEntity saveCustomParameters(@RequestBody List<CustomParametersEntity> customParametersEntityList){
        return ResultUtils.build(componentService.saveCustomParameters(customParametersEntityList));
    }
    ...
    //根据项目id查询最新的操作日志(弹窗提示部署失败信息)
    @GetMapping(value = "/{projectId}/deploymentLogs")
    public ResultEntity getDeploymentLogByProjectId(@PathVariable(value = "projectId") String projectId){
        return ResultUtils.build(deployLogService.getDeploymentLogByProjectId(projectService.getProjectById(projectId)));
    }

//    // 根据Id查询组件
//    @GetMapping(value = "/{projectId}/components/TestProgram")
//    public ResultEntity getTestProgramByDeletedAndProject(@PageableDefault(sort = "createTime", direction = Sort.Direction.DESC) Pageable pageable, @PathVariable(value = "projectId") String projectId, @RequestParam(value = "deleted") boolean deleted) {
//        return ResultUtils.build(componentService.getComponentsByDeletedAndProjects(pageable, deleted, projectService.getProjectById(projectId)));
//    }
}
